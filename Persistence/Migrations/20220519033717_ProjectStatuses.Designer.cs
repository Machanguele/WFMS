...
namespace Persistence.Migrations
{
    ...
    [Migration("20220519033717_ProjectStatuses")]
    partial class ProjectStatuses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Project", b =>
                {
                    ...
                    b.Property<string>("CreatedBUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Project", b =>
                {
                    b.HasOne("Domain.AppUser", "CreatedBUser")
                        .WithMany()
                        .HasForeignKey("CreatedBUserId");

                    b.HasOne("Domain.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId");

                    b.HasOne("Domain.ProjectStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId");

                    b.Navigation("CreatedBUser");
